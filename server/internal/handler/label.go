...
func (h *Handler) ListLabels(w http.ResponseWriter, r *http.Request) {
	...
	labels, err := h.Queries.ListLabelsByWorkspace(r.Context(), workspaceID)
	if err != nil {
...
func (h *Handler) DeleteLabel(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Queries.DeleteLabel(r.Context(), labelID); err != nil {
...
func (h *Handler) ListIssueLabels(w http.ResponseWriter, r *http.Request) {
	...
	labels, err := h.Queries.ListIssueLabels(r.Context(), issueID)
	if err != nil {
